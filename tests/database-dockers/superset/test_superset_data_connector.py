...
def _mock_superset_imports():
    """Patch the Superset helpers in the loader module."""
    import data_formulator.data_loader.superset_data_loader as sdl
    old_client, old_bridge = sdl.SupersetClient, sdl.SupersetAuthBridge
    sdl.SupersetClient = MockSupersetClient
    sdl.SupersetAuthBridge = MockAuthBridge
    yield

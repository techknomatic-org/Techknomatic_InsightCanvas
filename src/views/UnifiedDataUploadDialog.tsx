    ...
    return (
        <Dialog
            ...
            sx={{
                '& .MuiDialog-paper': {
                    m: 2,
                    width: activeTab === 'menu'
                        ? 'clamp(700px, 56vw, 820px)'
                        : (activeTab === 'add-connection' ? dialogWidth(980) : dialogWidth(1100)),
                    maxWidth: '92vw',
                    minHeight: activeTab === 'menu' ? 480 : undefined,
                    height: activeTab === 'menu'
                        ? 'auto'
                        : (activeTab === 'add-connection' ? dialogHeight(680) : dialogHeight(800)),
                    maxHeight: '90vh',
                    borderRadius: '16px',
                    boxShadow: '0 24px 48px -12px rgba(15, 23, 42, 0.25), 0 0 1px rgba(0, 0, 0, 0.1)',
                    display: 'flex',
                    flexDirection: 'column',
        ...
        >
            <DialogTitle sx={{ display: 'flex', alignItems: 'center', gap: 1, px: 3, pt: 2.5, pb: activeTab === 'menu' ? 1 : 1.5 }}>
                {activeTab !== 'menu' && !(activeTab === 'add-connection' && serverConfig.DISABLE_DATA_CONNECTORS) && (
                    <IconButton
                        size="small"
                        onClick={() => setActiveTab('menu')}
                        sx={{ mr: 0.5, borderRadius: '6px', color: '#64748b', '&:hover': { bgcolor: 'rgba(0,0,0,0.04)', color: '#0f172a' } }}
                    >
                ...
                {activeConnector ? (
                    ...
                    <Typography variant="h6" component="span" sx={{ fontSize: '18px', fontWeight: 700, color: '#0f172a', fontFamily: "'Inter', 'Roboto', sans-serif" }}>
            ...
            <DialogContent sx={{ flex: 1, overflow: 'hidden', p: 0 }}>
                ...
                <TabPanel value={activeTab} index="menu">
                    <Box sx={{ px: 3.5, py: 3, boxSizing: 'border-box', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        <Box sx={{ width: '100%' }}>
                            <DataLoadMenu

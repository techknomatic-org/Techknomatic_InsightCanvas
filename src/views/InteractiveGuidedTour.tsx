    ...
    const steps: TourStep[] = [
        {
            ...
            description: 'Use the top bar to switch between the Home workspace, the autonomous BI Hub, About page, Settings, and this Interactive Guide.',
            placement: 'bottom',
        ...
        },
        {
            ...
            badge: 'Step 3 of 4: BI Hub',
            title: 'BI Hub & Schema Discovery',
            description: 'Welcome to the BI Hub! Here you can profile relational databases, discover table schemas, and inspect foreign key relationships.',
            placement: 'bottom',
